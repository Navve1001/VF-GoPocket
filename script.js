...
$(document).ready(function () {
  $("#equity-calc-form").submit(function (event) {
    ...
    var equityIntradayBrokerage = equityIntrabrokerage1 + equityIntrabrokerage2;
    ...
    var equityDeliveryBrokerage = (equityBuyPrice > 0 ? 10 : 0) + (equitySellPrice > 0 ? 10 : 0);
...
$(document).ready(function () {
  $("#fno-calc-form").submit(function (event) {
    ...
    var fnoOptionsBrokerage = (fnoBuyPrice > 0 ? 10 : 0) + (fnoSellPrice > 0 ? 10 :0);
    ...
    var fnoFutureBrokerage = (fnoQty * fnoBuyPrice >= 33333 ? 10 : (fnoBuyPrice * fnoQty) * 0.0003) + (fnoQty * fnoSellPrice >= 33333 ? 10 : (fnoQty * fnoSellPrice) * 0.0003);
...
$(document).ready(function () {
  $("#currency-calc-form").submit(function (event) {
    ...
    var currencyFutureBrokerage = (currencyLotSize * currencyQty * currencyBuyPrice >= 33333 ? 10 : (currencyLotSize * currencyQty * currencyBuyPrice) * 0.0003) + (currencyLotSize * currencyQty * currencySellPrice >= 33333 ? 10 : (currencyLotSize * currencyQty * currencySellPrice) * 0.0003);
...
$(document).ready(function () {
  ...
  $("#commodity-calc-form").submit(function (event) {
    ...
    var commodityOptionsBrokerage = (BuyPrice > 0 ? 10 : 0) + (SellPrice > 0 ? 10 : 0);
    ...
    var commodityFutureBrokerage = (lotSize * lots * BuyPrice >= 33333 ? 10 :(lotSize * lots * BuyPrice) * 0.0003) + (lotSize * lots * SellPrice >= 33333 ? 10 :(lotSize * lots * SellPrice) * 0.0003) ;
